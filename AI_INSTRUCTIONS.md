...
### Этап 1: Создание структуры (ИИ)

1. **Создать файл** с `<head>` (meta, title, description, критический CSS)

2. **Добавить placeholder для header:**
```html
<!-- ================================================== -->
...
3. **Создать `<main>`** с уникальным контентом страницы

4. **Для SVG иконок** использовать заглушки (пользователь вставит вручную):
```html
...
5. **Добавить placeholder для footer:**
```html
<!-- ================================================== -->
...
6. **Добавить JS-скрипты** (если есть уникальные для страницы)

7. **НЕ добавлять JSON-LD** на этом этапе

### Этап 2: Ручные правки (пользователь)

- [ ] Вставить header из эталона
- [ ] Вставить footer из эталона
...
### Этап 4: JSON-LD (после финализации)
