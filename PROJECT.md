...
> **Файл:** `src/html/js/reproduction-search.js` (~1445 строк, IIFE, ES5)
> **Калькулятор:** документация в [CALCULATOR.md § 11. Калькулятор репродукций](docs/CALCULATOR.md#11-калькулятор-репродукций-reproduction-searchjs)
...
Реализовано: массив `POPULAR_TAGS` (Винсент Ван Гог, Девятый вал, Клод Моне, Поцелуй Климт, Рембрандт, Боттичелли) рендерится под поисковой строкой как pill-кнопки. По клику подставляется текст в поле и запускается поиск.
