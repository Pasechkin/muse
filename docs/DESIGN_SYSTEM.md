...
<header class="bg-dark sticky top-0 z-50">
    <nav class="container h-20 flex items-center">
        ...
        <div class="hidden xl:flex items-center gap-x-8 h-full">
            <a href="https://muse.ooo/portret-na-zakaz/" class="text-xs font-bold uppercase tracking-wider text-white hover:text-ah-25 transition-colors">Портреты</a>
            <a href="https://muse.ooo/pechat/" class="text-xs font-bold uppercase tracking-wider text-white hover:text-ah-25 transition-colors">Печать</a>
            <a href="https://muse.ooo/info/" class="text-xs font-bold uppercase tracking-wider text-white hover:text-ah-25 transition-colors">О нас</a>
        </div>

        <!-- RIGHT -->
        <div class="hidden xl:flex items-center h-full ml-auto gap-x-6">
            <button type="button" class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-white hover:text-ah-25 transition-colors" data-open-dialog="city-dialog" data-city-trigger aria-controls="city-dialog" aria-label="Выбор города">
                <span class="border-b border-dotted border-white/40 hover:border-white" data-city-current>Санкт-Петербург</span>
                <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">...</svg>
            </button>
            <a href="tel:88007076921" class="text-sm font-medium text-white hover:text-ah-25 transition-colors whitespace-nowrap" data-city-phone>8 800 707-69-21</a>
            <a href="https://muse.ooo/order/" class="btn-header-cta">Заказать</a>
        </div>

        <button type="button" class="xl:hidden ml-auto p-2.5 text-white hover:text-ah-25" data-open-dialog="mobile-menu" aria-controls="mobile-menu" aria-label="Открыть меню">
...
```html
<dialog id="mobile-menu" class="mobile-menu-dialog backdrop:bg-ah-950/60 p-0 w-full max-w-none h-svh bg-dark sm:h-auto sm:max-w-sm sm:bg-transparent sm:ml-auto sm:mr-0">
    <div class="w-full h-full sm:h-auto sm:max-h-[85vh] sm:mx-auto bg-dark shadow-2xl overflow-y-auto" data-swipe-panel>
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <button type="button" class="text-white hover:text-ah-25" data-close-dialog aria-label="Закрыть меню">
            ...
            <nav class="flex flex-col space-y-4 mb-8">
                <a href="https://muse.ooo/portret-na-zakaz/" class="text-lg font-medium text-white hover:text-ah-25 transition-colors">Портреты</a>
                <a href="https://muse.ooo/pechat/" class="text-lg font-medium text-white hover:text-ah-25 transition-colors">Печать</a>
                <a href="https://muse.ooo/info/" class="text-lg font-medium text-white hover:text-ah-25 transition-colors">О нас</a>
            </nav>

            <div class="flex items-center justify-between py-4 mb-4">
                <button type="button" class="flex items-center gap-2 text-sm text-white hover:text-ah-25 transition-colors" data-open-dialog="city-dialog" data-city-trigger aria-controls="city-dialog" aria-label="Выбор города">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">...</svg>
                    <span data-city-current>Санкт-Петербург</span>
                    <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">...</svg>
                </button>
                <a href="tel:88007076921" class="text-sm font-medium text-white hover:text-ah-25 transition-colors" data-city-phone>
                    <span data-city-phone-text>8 800 707-69-21</span>
                </a>
            </div>

            <div class="pt-4">
                <div class="text-[10px] font-bold uppercase tracking-widest text-white/60 mb-4">Написать нам</div>
...
```html
<dialog id="city-dialog" class="backdrop:bg-ah-950/60 hidden open:block sm:open:flex p-0 w-full max-w-none h-svh bg-white border-0 outline-none sm:h-auto sm:open:fixed sm:open:inset-0 sm:open:z-50 sm:open:bg-ah-950/60 sm:open:items-center sm:open:justify-center sm:open:p-6">
    <div class="w-full h-full bg-white sm:h-auto sm:w-full sm:max-w-city sm:rounded-3xl shadow-2xl overflow-hidden">
        <div class="p-6 pb-4 border-b border-ah-200 sticky top-0 bg-white">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-2xl text-ah-950">Выберите город</h2>
                <button type="button" class="p-2 text-ah-500 hover:text-ah-950" data-close-dialog aria-label="Закрыть">...</button>
            </div>
            <label for="city-search" class="sr-only">Поиск города</label>
            <input type="text" id="city-search" class="w-full bg-ah-50 rounded-2xl border border-ah-200 px-5 py-4 text-lg text-ah-950 placeholder:text-ah-400" placeholder="Найти ваш город..." autocomplete="off">
        </div>
        ...
        <div class="p-6 pt-4 overflow-y-auto max-h-[calc(100svh-170px)] sm:max-h-[80vh]">
            ...
            <div id="city-no-results" class="hidden text-center py-16 bg-ah-50 rounded-3xl border-2 border-dashed border-ah-200 mt-4">
                <p class="text-ah-500 font-bold text-lg">В этом городе пока нет нашей студии</p>
                <p class="text-ah-500 text-sm mt-2">Попробуйте выбрать ближайший к вам крупный город из списка миллионников.</p>
...
### Amber Harmonized — основная палитра

| Токен | HEX | Использование |
|-------|-----|---------------|
| `--color-ah-25` | #FFFDFA | Основной фон body и контентных секций, ink-on-dark |
| `--color-ah-50` | #FFF9F3 | Фон hero-секций (blog, info), активные элементы, focus |
| `--color-ah-75` | #FEF5EA | Модальные header/footer |
| `--color-ah-100` | #FEF1E1 | Hover кнопок (не используется как фон body) |
| `--color-ah-200` | #FDE5C8 | Бордюры, secondary, ink-muted-on-dark |
| `--color-ah-300` | #C59A5E | Промежуточный тёплый акцент |
| `--color-ah-400` | #A97D3A | Placeholder, focus-border |
| `--color-ah-500` | #8B6420 | Текст ссылок (city-dialog), no-results |
| `--color-ah-600` | #D97706 | Акцент, eyebrow, иконки, focus-ring |
| `--color-ah-700` | #B45309 | Бордюры active, ink-muted |
| `--color-ah-800` | #8B4C04 | ink-label, primary-text |
| `--color-ah-900` | #593102 | ink-soft |
| `--color-ah-950` | #281601 | ink (заголовки/текст), primary, body |
| `--color-ah-975` | #140B01 | Тёмный фон (hero, CTA, footer) |

### Семантические токены (маппинг на amber)

| Токен | Значение | Назначение |
|-------|---------|---------------|
| `--color-primary` | #140B01 (ah-975) | Бренд-цвет, кнопки, фоны |
| `--color-primary-hover` | #281601 (ah-950) | Hover кнопок |
| `--color-primary-light` | #FEF1E1 (ah-100) | Светлый фон активных элементов |
| `--color-primary-text` | #8B4C04 (ah-800) | Текстовые ссылки, галочки |
| `--color-primary-text-hover` | #593102 (ah-900) | Hover ссылок |
| `--color-dark` | #140B01 (ah-975) | Тёмный фон, заголовки |
| `--color-body` | #281601 (ah-950) | Основной текст |
| `--color-secondary` | #FDE5C8 (ah-200) | Бордюры, декоративные элементы (не используется как фон секций) |

### Семантические цвета статусов

Токены для валидации, предупреждений и успешных действий, определены в `@theme`:

| Токен | HEX | Назначение |
|-------|-----|------------|
| `--color-success` | `#22c55e` | Успешные действия (отправка формы, callback-success) |
| `--color-warning` | `#eab308` | Предупреждения (качество фото, `calc-alert-warning`) |
| `--color-error` | `#ef4444` | Ошибки валидации (пустые поля, `.form-input.error`) |

Использование в Tailwind: `text-success`, `bg-warning`, `border-error` и т. д.

### Ink-система (утилиты цвета текста)

**На светлых фонах (ah-25 / ah-50 / ah-75 / white):**

| Класс | Цвет | Контраст | Использование |
|-------|------|----------|---------------|
| `text-ink` | ah-950 #281601 | ≥ 16:1 AA ✅ | Заголовки, основной текст |
| `text-ink-soft` | ah-900 #593102 | ≥ 10:1 AA ✅ | Подзаголовки, описания |
| `text-ink-muted` | ah-700 #B45309 | ≥ 6:1 AA ✅ | Второстепенный текст |
| `text-ink-label` | ah-800 #8B4C04 | ≥ 6:1 AA ✅ | Метки, подписи |

**На тёмных фонах (ah-950 / ah-975):**

| Класс | Цвет | Контраст | Использование |
|-------|------|----------|---------------|
| `text-ink-on-dark` | ah-25 #FFFDFA | 16:1 | Белый текст на тёмном |
| `text-ink-muted-on-dark` | ah-200 #FDE5C8 | 15:1 | Приглушённый текст на тёмном |

#### Фоны

Стандарт фонового зонирования (эталон — `portret-maslom.html`):

| Зона | Класс | Цвет | Страницы |
|------|-------|------|----------|
| **Body** | `bg-ah-25` | #FFFDFA | Все страницы |
| **Hero (blog/info)** | `bg-ah-50` | #FFF9F3 | blog/, info/ |
| **Контентные секции** | `bg-ah-25` | #FFFDFA | Все страницы |
| **Тёмные секции** (hero продуктовых, CTA, footer) | `bg-ah-975` | #140B01 | Все страницы |

> **Запрещено** на секциях: `bg-white`, `bg-dark`, `bg-secondary`, `bg-primary` — заменяются на `bg-ah-25` / `bg-ah-975`.
> CTA-секции используют CSS-класс `.cta-section` (уже содержит `bg-ah-975`).

```html
<!-- Тёмный фон (hero продуктовых, CTA, footer) -->
<div class="bg-ah-975 text-ink-on-dark">…</div>

<!-- Hero блога / info — чуть теплее -->
<section class="pt-8 pb-8 lg:pt-12 lg:pb-12 bg-ah-50">…</section>

<!-- Контентная секция -->
<section class="bg-ah-25 py-16 lg:py-24">…</section>

<!-- Body -->
<body class="bg-ah-25 …">…</body>
```

#### Вертикальные отступы секций

Секции используют **адаптивные** вертикальные отступы: компактнее на мобильных,
просторнее на десктопе. Стандарт — `py-16 lg:py-24` (64 px → 96 px).

| Тип секции | Мобильные | Десктоп (lg:) | Tailwind классы |
|------------|-----------|---------------|-----------------|
| **Основные секции** | 64 px | 96 px | `py-16 lg:py-24` |
| **Hero** | 48 px | 48 px | `py-12` |
| **CTA** | 96 px | 128 px | `py-24 md:py-32` |
| **Footer** | 32 px | 48 px | `py-8 lg:py-12` |
| **Промо-баннер** | 24 px | 24 px | `py-6` |
...
```html
<!-- Основной текст -->
<p class="text-ink">Основной текст</p>

<!-- Приглушённый -->
<p class="text-ink-muted">Второстепенный текст</p>

<!-- На тёмном фоне -->
<div class="bg-ah-975">
  <p class="text-ink-on-dark">Белый текст</p>
  <p class="text-ink-muted-on-dark">Приглушённый</p>
</div>
```

**Правило цвета текста по фону:**
- Белый / светлый фон → `text-ink` / `text-ink-soft`
- Тёмный фон (`bg-ah-975`, `bg-ah-950`) → `text-ink-on-dark`
- Метки / подписи → `text-ink-label` / `text-ink-muted`

**Контраст (A11y):** все ink-утилиты проверены на WCAG AA. Не используйте `text-gray-*` — вместо них ink-система.

---

### Текст на тёмном фоне: навигационные компоненты (white-система)

Для **навигационных компонентов** на тёмном фоне (`bg-ah-975`) — header, footer, мобильное меню —
используется **white-система** вместо ink-on-dark. Отличие: чистый white без тёплого оттенка,
с opacity-модификаторами для иерархии.

> **Когда что использовать:**
> - **ink-on-dark** (ah-25 / ah-200) — контентные секции на тёмном фоне (hero, CTA, описания)
> - **white-система** — навигация: header, footer, мобильное меню, хлебные крошки

#### Иерархия цветов

| Роль | Класс | Значение | Контраст на ah-975 | Применение |
|------|-------|----------|---------------------|------------|
| **Primary** | `text-white` | `#FFFFFF` (100%) | 19.3:1 AAA ✅ | Кликабельные элементы: ссылки, телефоны, логотип, время работы |
| **Secondary** | `text-white/60` | `rgba(255,255,255,0.6)` | ~11.6:1 AAA ✅ | Второстепенный текст: заголовки разделов, подписи, метки, юр. данные, копирайт |

Промежуточные значения (`white/70`, `white/40`) **не используются** — только два уровня.

#### Hover-поведение ссылок

```
Обычное состояние:  text-white      (100%)
При наведении:      text-white/60   (60%)
```

| Тип элемента | Обычное | Hover | Примечание |
|-------------|---------|-------|-----------|
| Навигационные ссылки | `text-white` | `hover:text-white/60` | Портреты, Печать, О нас |
| Текстовые ссылки (footer) | `text-white` | `hover:text-white/60` | Услуги, Информация |
| Телефоны | `text-white` | `hover:text-white/60` | 8 800, +7 495, +7 812 |
| Иконки соцсетей | `text-white` | `hover:text-white/60` | SVG через `fill-current` |
| Логотип (SVG) | `fill-white` | `hover:opacity-60` | opacity, т.к. `fill-` не имеет hover:text |
| CTA-кнопка «Заказать» | `btn-header-cta` | собственные стили | **Не приглушается** |
| Некликабельный текст | `text-white/60` | — | Не реагирует на hover |

#### Что НЕ приглушается при hover

- CTA-кнопка «Заказать» — акцентный элемент, всегда выделен
- Мессенджеры в мобильном меню (WhatsApp, Telegram, VK, Max) — брендовые цвета фона

#### Tailwind-паттерны

```html
<!-- Навигационная ссылка (header / footer) -->
<a href="…" class="text-white hover:text-white/60 transition-colors">Пункт</a>

<!-- Заголовок раздела (footer) -->
<h3 class="text-xs font-bold uppercase tracking-widest text-white/60">Услуги</h3>

<!-- Подпись / метка -->
<p class="text-xs text-white/60">Бесплатно по России</p>

<!-- Телефон -->
<a href="tel:…" class="text-white hover:text-white/60 transition-colors">8 800 707-69-21</a>

<!-- Логотип -->
<a href="…" class="opacity-100 hover:opacity-60 transition-opacity">
  <svg class="fill-white">…</svg>
</a>

<!-- Иконка соцсети (footer, без фоновой подложки) -->
<a href="…" class="w-9 h-9 flex items-center justify-center text-white hover:text-white/60 transition-colors">
  <svg class="w-5 h-5 fill-current">…</svg>
</a>

<!-- Статический текст (юр. данные) -->
<span class="text-sm text-white/60">ИНН 782575923262</span>

<!-- Копирайт -->
<div class="text-sm text-white/60">© 2015—2026 Muse</div>
```

#### Размеры текста в навигации

| Компонент | Desktop | Mobile |
|-----------|---------|--------|
| Header: пункты меню | `text-[11px] font-bold uppercase tracking-wide` | `text-lg font-medium` (мобильное меню) |
| Header: телефон | `text-sm font-medium` | `text-sm font-medium` |
| Footer: ссылки | `text-sm` | `text-sm` |
| Footer: заголовки | `text-xs font-bold uppercase tracking-widest` | `text-xs` |
| Footer: подписи | `text-xs` | `text-xs` |

#### CSS-утилиты навигации на тёмном фоне (✅ унифицированы)

Следующие утилиты в `input.css` приведены к white-системе:

| Утилита | Поведение |
|---------|-----------|
| `link-on-dark-plain` | `#fff → hover:white/60` |
| `.breadcrumbs a` | `#fff → hover:white/60` |
| `.breadcrumbs` (разделители) | `white/60` |

> `link-on-dark` (с underline + primary цвет) — отдельный случай для инлайновых ссылок
> в текстовых блоках, не относится к навигации. Сохраняется as-is.

---

## Z-index карта

Системная шкала z-index. Токены определены в `@theme` (`input.css`), инлайн-значения используются только в рамках этой шкалы.

| Токен / значение | Z-index | Элементы |
|------|---------|----------|
| `--z-index-notification` | `40` | Cookie-баннер, City-баннер |
| `--z-index-widget` | `50` | Back-to-top, Messenger Widget, Header (sticky) |
| `z-100` (inline) | `100` | Review modal overlay |
| `--z-index-modal` | `9999` | Page Navigator, Modal shell, Video modal |
| `--z-index-lightbox` | `10000` | Lightbox |
| `z-[10001]` (inline) | `10001` | Lightbox close button |

**Правило:** новые элементы должны вписываться в эту шкалу, а не использовать произвольные z-index.
...
| Токен | Значение | Назначение |
|-------|----------|------------|
| `container` | max-width: 1170 px, padding 1 rem | Основной контейнер страницы |
| `--max-w-city` | 48 rem (768 px) | Макс. ширина диалога выбора города (`max-w-city`) |
...
## Архитектура CSS: уровни абстракции

Проект использует Tailwind CSS v4 с четырьмя уровнями стилизации. Выбор уровня зависит от масштаба повторного использования.

| Уровень | Механизм Tailwind v4 | Когда использовать | Примеры из проекта |
|---------|----------------------|--------------------|---------------------|
| **1. Токены** | `@theme` в `input.css` | Системное значение, используется в 3+ местах | `--color-primary`, `--transition-fast`, `--z-index-modal` |
| **2. Утилиты** | `@utility` в `input.css` | Повторяющийся паттерн из 1–3 CSS-свойств | `text-ink`, `content-auto`, `link-on-dark`, `eyebrow` |
| **3. Компоненты** | `@layer components` в `input.css` | Устойчивая группа свойств, вложенность, состояния | `btn-primary`, `form-input`, `modal-shell`, `notification-banner` |
| **4. Inline-классы** | Классы Tailwind в HTML | Всё остальное — layout, spacing, одноразовая стилизация | `flex items-center gap-4 py-16 lg:py-24` |

**Правила принятия решения:**

1. Если значение системное и используется повсюду — добавить **токен** в `@theme`
2. Если один и тот же набор из 1–3 свойств повторяется на 3+ страницах — создать **`@utility`**
3. Если компонент имеет вложенные элементы или состояния (hover, disabled, is-open) — создать класс в **`@layer components`**
4. Во всех остальных случаях — **inline-классы** Tailwind прямо в HTML

**Запрещено:**
- `!important` — не используется ни в утилитах, ни в компонентах
- Arbitrary values `[value]` — только если нет подходящего токена или стандартной утилиты Tailwind. Допустимые исключения: `aspect-[W/H]`, `max-h-[calc(...)]`, единичные цвета мессенджеров `bg-[#25d366]`
- Прямое редактирование `output.css` — файл генерируется автоматически

**Где редактировать CSS:** только `src/input.css`. Подробнее о сборке — в [README.md](../README.md#техническая-часть).

### Сканирование файлов (`@source`)

Tailwind v4 сканирует HTML и JS для генерации утилит. Директивы `@source` в начале `input.css`:

```css
@source "../src/html/**/*.html";   /* Все HTML-страницы */
@source "../src/html/js/**/*.js";  /* Скрипты (динамические классы) */
@source not "../catalyst-ui-kit";  /* Исключить неиспользуемые шаблоны */
@source not "../Stack 1.5.2";
```

При добавлении новой директории со страницами — добавить соответствующий `@source`.
...
Базовые стили = мобильные. Расширяем через breakpoint-префиксы:

| Префикс | Min-width | Устройства |
|---------|-----------|------------|
| *(без)* | 0 | Мобильные (базовые стили) |
| `sm:` | 640 px | Большие телефоны, маленькие планшеты |
| `md:` | 768 px | Планшеты |
| `lg:` | 1024 px | Ноутбуки, десктоп |
| `xl:` | 1280 px | Большие экраны |

### Стандартные паттерны

**Секции (вертикальный ритм):**
- Основные: `py-16 lg:py-24`
- CTA: `py-24 md:py-32`
- См. таблицу в разделе [Вертикальные отступы секций](#вертикальные-отступы-секций)
...
<!-- 1 колонка → 2 (достаточно md) -->
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
```

**Типографика:**
```html
<h1 class="heading-hero">…</h1>        <!-- Внутри класса уже есть responsive-размеры -->
<h2 class="heading-section">…</h2>     <!-- text-3xl lg:text-4xl — встроено -->
```

**Скрытие/показ элементов:**
```html
<div class="hidden md:flex">…</div>    <!-- Показать только на md+ -->
<div class="md:hidden">…</div>         <!-- Только мобильные -->
```

### Правила

- **`max-*` диапазоны** — допустимы только в CSS (`@media (max-width: …)`), не как inline-классы. Пример: Page Navigator скрыт ниже 1024 px через CSS в `input.css`
- **Custom breakpoints** — не используем. Стандартных sm/md/lg/xl достаточно
- **Container queries** — не используются в текущей версии
- **Dark mode** — вне scope проекта. Классы `dark:` не применяются
...
Используем два self-hosted шрифта (woff2 в `src/html/fonts/`):

| Шрифт | CSS-токен | Назначение | Начертания |
|-------|-----------|-------------|---------------|
| **Playfair Display** | `--font-display` | Заголовки (H1–H4): `.heading-hero`, `.heading-section`, `.heading-subsection`, `.heading-card` | 400, 400i, 700, 700i |
| **PT Sans** | `--font-sans` | Основной текст, кнопки, UI | 400, 400i, 700, 700i |
...
**Классы:**
- `.font-display` — утилита Tailwind для Playfair Display
- `.font-sans` — Tailwind default (PT Sans)
- `.eyebrow` — PT Sans, 12px, uppercase, tracking 0.12em, цвет ah-600
...
|------------|-----------|----------------|
| `bg-white` / `bg-ah-25` | `text-ink` (ah-950) | `text-ink` (ah-950) |
| `bg-ah-50` / `bg-ah-100` | `text-ink` (ah-950) | `text-ink-soft` (ah-900) |
| `bg-ah-950` / `bg-ah-975` | `text-ink-on-dark` (ah-25) | `text-ink-on-dark` (ah-25) |

**Реализация:** в CSS используется `:where()` для понижения специфичности — это позволяет Tailwind-утилитам и ink-классам при необходимости переопределять цвета.

```css
/* Пример из input.css */
:where(.bg-ah-975, .bg-ah-950) { color: var(--color-ah-25); }
:where(.bg-ah-975, .bg-ah-950)
  :is(.heading-hero, .heading-section, ...) { color: var(--color-ah-25); }
```
...
<!-- H6 — Подпись, метка -->
<h6 class="text-base font-medium text-ink-muted">Примечание</h6>
```
...
| Мелкий текст | `text-sm text-ink-muted` | по ситуации | Подписи, примечания |
...
<p class="text-sm text-ink-muted">Дополнительная информация</p>
```
...
```html
<!-- Ссылка на другую страницу нашего сайта (БЕЗ стрелок) -->
<p>
    Подробнее в разделе 
    <a href="/info/dostavka/" class="text-primary-text underline hover:no-underline">Доставка</a>
</p>

<!-- Ссылка внутри страницы — якорь ВВЕРХ (↑) -->
<a href="#calc" class="text-primary-text underline hover:no-underline">Цена ↑</a>

<!-- Ссылка внутри страницы — якорь ВНИЗ (↓) -->
<a href="#opisanie" class="text-primary-text underline hover:no-underline">Описание ↓</a>

<!-- Ссылка на тёмном фоне (с подчёркиванием) -->
...
- Белый текст `#ffffff`
- Подчёркивание ah-600 `#D97706` (2px толщиной)
- Отступ подчёркивания 2px

**Стили `link-on-dark-plain`:**
- Белый текст `#fff`
- Без подчёркивания
- При наведении → `rgba(255,255,255,0.6)`
...
|------|---------------|--------|
| `text-ink` (ah-950 #281601) | ≥16:1 | ✅ OK для любого текста |
| `text-ink-soft` (ah-900 #593102) | ≥10:1 | ✅ OK для любого текста |
| `text-ink-muted` (ah-700 #B45309) | ≥6:1 | ✅ OK для любого текста |
| `text-ink-label` (ah-800 #8B4C04) | ≥7:1 | ✅ OK |
| `--color-ah-600: #D97706` | ~4.6:1 | ✅ OK для крупного текста (≥18px), иконок, акцентов |

**Рекомендация:** для основного текста использовать `text-ink` (заголовки, основной текст) или `text-ink-soft` (подзаголовки, описания).
...
### Touch-target (минимальный размер нажатия)

Интерактивные элементы должны быть не менее **44×44 px** (WCAG 2.5.8 — Target Size).

| Компонент | Текущий размер | Статус |
|-----------|----------------|--------|
| UI Controls (`--sm`) | 32×32 px | ⚠️ Допустимо рядом с текстом |
| UI Controls (`--md`) | 44×44 px | ✅ OK |
| UI Controls (`--lg`, `--xl`) | 48–64 px | ✅ OK |
| Кнопки (`btn-*`) | ≥ 48 px высота | ✅ OK |
| Ссылки мессенджеров | 48×48 px | ✅ OK |
| Page Navigator (точки) | padding обеспечивает 44 px | ✅ OK |

**Правило:** если кнопка визуально меньше 44 px — увеличить кликабельную зону через `p-*` или `min-h-11 min-w-11`.

### Icon-only элементы

Элементы, представленные только иконкой (без видимого текста), **обязательно** должны содержать:

```html
<!-- Вариант 1: aria-label -->
<button aria-label="Закрыть">
    <svg>…</svg>
</button>

<!-- Вариант 2: sr-only текст -->
<button>
...
SVG-иконки внутри кнопок — всегда `aria-hidden="true"` (текст передаётся через кнопку, не через SVG).

### Длинные заголовки

Для заголовков H1–H2, которые могут некрасиво переноситься на мобильных, рекомендуется:

```html
<h1 class="heading-hero text-balance">…</h1>
```
...
Матрица интерактивных состояний — какие состояния применяются к каким компонентам:

| Компонент | `hover` | `focus-visible` | `disabled` | `aria-expanded` | Доп. состояния |
|-----------|---------|-----------------|------------|-----------------|----------------|
| **Кнопки** (`btn-*`) | bg/opacity | `ring-2 ring-offset-2` | `opacity-50 cursor-not-allowed` | — | — |
| **Ссылки** | `underline` ↔ `no-underline` | `outline` | — | — | — |
| **Формы** (`form-input`) | — | `ring-2 ring-ah-400` | `opacity-50` | — | `.error` (JS — красная рамка) |
| **Модалки** (`modal-shell`) | — | — | — | `aria-expanded` | `open:block` / `open:flex` |
| **Аккордеоны** | — | `outline` | — | `aria-expanded` | `open` (на `<details>`) |
| **UI Controls** | opacity +0.2 | `ring-2 ring-white/70` | — | — | — |
| **Виджет мессенджеров** | — | `ring-2 ring-white/70` | — | `aria-expanded` | `.is-open` (JS) |
| **Notification Banners** | — | — | — | — | `.is-visible` (JS) |
| **Чекбоксы** (`calc-checkbox`) | — | `ring-2` | — | — | `checked` → `accent-color` |
| **Вкладки** (tabs) | bg | `outline` | — | `aria-selected` | `.is-active` (JS) |

**Общие правила:**
- `hover:` — только для указателей мыши (не для touch). Tailwind v4 обрабатывает это автоматически через `@media (hover: hover)`
- `focus-visible:` — предпочтительнее `focus:` (не показывает кольцо при клике мышью)
- `transition-colors` / `transition-opacity` — добавлять к элементам с hover/focus для плавности
- Время перехода: `duration-200` (стандарт) или `var(--transition-fast)` для hover-эффектов
...
<!-- Helper -->
<p class="text-sm text-ink-muted mt-1">[ТЕКСТ: Подсказка]</p>
...
#### Кнопка закрытия (крестик) — единый паттерн

Все модальные окна используют компонент `.ui-control` — тёмный полупрозрачный круг с белой иконкой:

```html
<button type="button" data-close-dialog class="ui-control ui-control--md focus:outline-none" aria-label="Закрыть">
    <svg fill="none" stroke="currentColor" stroke-width="1.5"
         stroke-linecap="round" stroke-linejoin="round"
         aria-hidden="true" class="w-6 h-6" viewBox="0 0 24 24">
...
|----------|----------|------------|
| Компонент | `.ui-control .ui-control--md` | 44×44px, `border-radius: 9999px` |
| Фон | `rgba(0,0,0,0.4)` → hover `rgba(0,0,0,0.6)` | Полупрозрачный тёмный круг |
| Цвет иконки | `white` | Белая иконка (stroke) |
| SVG stroke | `1.5`, `round` linecap/join | Тонкий, элегантный штрих |
| Доступность | `aria-label="Закрыть"`, `aria-hidden="true"` на SVG | |

**Эталон:** кнопка закрытия в модальном окне калькулятора (frame-modal, `#close-frame-modal`).

**Применяется к:** Frame (baguette) modal, Lightbox, Review modal, Video modal.

**Исключение:** мобильное меню (тёмный фон) — использует `text-ah-200 hover:text-white`.

**Важно:** Для багета и lightbox кнопка привязана через `id` (JS `calc.js`), `data-close-dialog` — опционально. Для остальных `data-close-dialog` обязателен (JS `nav.js`).
...
| `.btn-ghost` | Текстовая кнопка для notification-баннеров | Прозрачный | `ah-800` |
...
- `.btn-ghost` → `hover:text-ah-950 + underline` (подчёркивание)
...
<button class="btn-ghost">Принять</button>
<button class="btn-ghost">Верно</button>
...
#### Секция акции: `.sale-banner`

Универсальный компонент для промо-баннеров и акций. Используется как отдельная секция на всех страницах сайта.

**Базовый вариант** (светлый фон):
```html
<section class="sale-banner">
    <p class="sale-banner-text">
        Скидка 20% &mdash; с 6 по 7 марта
    </p>
</section>
```

**Модификатор `--dark`** (тёмный фон):
```html
<section class="sale-banner sale-banner--dark">
    <p class="sale-banner-text">
        Скидка 20% &mdash; с 6 по 7 марта
    </p>
</section>
...
| Вариант | Фон | Текст | Где используется |
|---------|-----|-------|------------------|
| Базовый | `ah-50` (мягкий тёплый) | `ah-600` (акцентный amber) | pechat-страницы |
| `--dark` | `ah-975` (почти чёрный) | `ah-600` (акцентный amber) | портретные страницы |

**CSS (input.css):**
- Padding: `1rem 1.25rem`, на lg: `padding-inline: clamp(2rem, 6vw, 5rem)`
- Текст: `clamp(0.95rem, 1.3vw, 1.05rem)`, `font-weight: 500`, `letter-spacing: 0.02em`
...
**Фон секции:** диагональный градиент `135deg` на основе amber.
- `linear-gradient(135deg, var(--color-ah-800) 0%, var(--color-ah-700) 50%, var(--color-ah-600) 100%)`

**Текст по фону:**
- Текст на фоне секции (градиент/тёмный) — белый (`text-ink-on-dark`)
- Текст внутри белых карточек — `text-ink` / `text-ink-soft`

**Иконки:**
- Иконки преимуществ всегда ah-600 (используем `.icon-advantage`)
...
| `--lg` | 48×48px | 24×24px | Back to Top, Messenger Widget, Carousel arrows |
...
**Кнопка виджета мессенджеров (`#messengerToggle`):**
```html
<button id="messengerToggle"
    class="ui-control ui-control--lg"
    aria-expanded="false"
    aria-label="Открыть мессенджеры">
    <svg fill="none" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round"
            d="M8.625 12a.375.375 0 1 1-.75 0 ..."/>
    </svg>
</button>
```
...
| Класс | Назначение |
|-------|-----------|
| `.notification-banner` | Базовый: fixed, max-width 22rem, фон `ah-25`, скруглённые углы, тень, opacity-анимация |
...
<div id="cookieBanner" class="notification-banner notification-banner--bottom" role="alert">
    <p class="text-sm text-body leading-relaxed mb-3">
        ...
        <a href="info/politika-konfidentsialnosti-sayta.html" class="text-primary-text hover:text-ah-600-hover underline">рекомендательные системы</a>.
    </p>
    <button id="cookieAccept" class="btn-ghost">Принять</button>
</div>
```
...
<div id="cityBanner" class="notification-banner notification-banner--top" role="alert">
    <p class="text-sm text-body leading-relaxed mb-3">
        Ваш город: <strong class="text-ah-950" data-city-current>Санкт-Петербург</strong>?
    </p>
    <div class="flex gap-4">
        <button id="cityConfirm" class="btn-ghost">Верно</button>
        <button id="cityChange" class="btn-ghost">Изменить</button>
    </div>
</div>
```
...
<section class="bg-secondary py-24 md:py-32">
    <div class="container xl:flex xl:items-center xl:justify-between">
        ...
        <div class="mt-10 flex flex-col md:flex-row items-center gap-4 md:gap-x-6 xl:mt-0 xl:shrink-0">
            ...
            <a href="#" class="inline-block px-6 py-2 bg-dark hover:bg-ah-900 text-white rounded uppercase transition-colors w-full md:w-auto text-center">
                Обратный звонок
            </a>
        </div>
    </div>
...
#### Фоновые числа шагов (`.step-number-giant`)

На страницах стилей портретов (секция «Как заказать») каждый шаг имеет крупную полупрозрачную цифру на фоне.

```html
<div class="relative pl-20 sm:pl-28 lg:pl-36 py-6">
    <div class="absolute left-0 sm:left-0 lg:left-2 -top-4 sm:-top-6 lg:-top-8
                font-extralight step-number-giant leading-none select-none pointer-events-none">
        1
    </div>
    <h3 class="heading-card mb-2">Заголовок шага</h3>
    <p class="text-ink-soft">Описание...</p>
</div>
```

**CSS (`.step-number-giant`, `input.css` → `@layer components`):**

| Свойство | Значение |
|----------|----------|
| Размер (моб.) | `6.6rem` (~106px) |
| Размер (sm) | `8rem` (128px) |
| Размер (lg) | `10rem` (160px) |
| Градиент | `linear-gradient(135deg, ah-600 → ah-200)` |
| Clip | `background-clip: text` + `-webkit-text-fill-color: transparent` |
| Прозрачность | `opacity: .12` |
...
```html
<div class="flex p-1 bg-ah-50 rounded-lg" role="radiogroup" aria-label="Тип подрамника">
    <button class="wrap-btn flex-1 py-2 rounded-md text-xs font-bold transition
                   bg-white text-body shadow-sm" data-val="STANDARD"
            role="radio" aria-checked="true">Стандартный</button>
    <button class="wrap-btn flex-1 py-2 rounded-md text-xs font-medium transition"
            data-val="GALLERY" role="radio" aria-checked="false">Толстый</button>
</div>
```

Активная кнопка получает класс `.is-active` через JS.

**Состояния `.wrap-btn`** (определены в `input.css`):

| Состояние | Фон | Текст | Граница | Дополнительно |
|-----------|-----|-------|---------|---------------|
| **Rest** (не выбрана) | прозрачный (наследует `bg-ah-50` контейнера) | `ah-700` | — | `font-medium` |
| **Hover** | `ah-100` | `ah-950` | — | — |
| **Active / Selected** (`.is-active`) | `ah-50` | `ah-950` | `1px solid ah-700` | `font-bold`, `shadow: 0 1px 2px rgba(0,0,0,.06)` |
...
### Секция «Оформление в багет» (`#frame-section`)

Триггер открытия модалки выбора багета. Стилизован как кликабельная карточка.

```html
<div id="frame-section"
     class="border border-ah-200 rounded-lg p-4 flex items-center gap-4
            cursor-pointer hover:border-ah-700 hover:bg-ah-50 transition group bg-white">
    <div class="w-10 h-10 bg-ah-50 rounded border border-ah-200
    ...
    <div>
        ...
        <div class="text-xs text-ink font-medium group-hover:underline">Выбрать из каталога →</div>
    </div>
</div>
```

**Hover-эффект** (HTML-утилиты + `input.css`):

| Элемент | Rest | Hover |
|---------|------|-------|
| Карточка | `border-ah-200`, `bg-white` | `border-ah-700`, `bg-ah-50` |
| Иконка (`.w-10`) | `bg-ah-50`, `border-ah-200` | `bg-ah-600`, `border-ah-600` |
| SVG в иконке | `text-ink-muted` | `color: ah-25` (белый) |
| Ссылка «Выбрать» | без подчёркивания | `underline` |

> **Примечание:** hover-эффект на иконке (`.w-10` → `bg-ah-600`) задаётся в `input.css` через `#frame-section:hover .w-10`.
...
### Десктопный бар цены (`#desktop-price-bar`)

Нижняя полоса правой панели калькулятора (видима только на `lg+`). Показывает итоговую цену со скидкой.

```html
<div id="desktop-price-bar" class="hidden lg:block px-6 pt-2 pb-6 bg-white">
    <div class="flex items-baseline justify-between">
        <span class="text-sm text-ink-muted">Цена со скидкой 20%</span>
        <span class="text-2xl font-bold text-ink leading-none whitespace-nowrap">
            <span id="total-price">890</span> ₽
        </span>
    </div>
</div>
```
...
|----------|----------|
| Фон | `ah-25` |
| Скругление | `0 0 1rem 1rem` (нижние углы calc-panel) |
| Цвет цены | `ah-950` (через `#desktop-price-bar span`) |
| Цвет подписи | `text-ink-muted` (утилитой в HTML) |

> **Примечание:** в HTML используется `text-ink` (= `ah-950`), не `text-primary`. Это корректно — цена должна быть максимально контрастной.
...
<figure class="my-8">
    <img 
        ...
        height="600"
    >
    <figcaption class="text-center text-small text-ink mt-2">
...
```html
<blockquote class="border-l-4 border-primary pl-4 py-2 italic text-ink-soft bg-gray-50 rounded-r">
...
<article class="flex flex-col h-full bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow group">
    ...
    <div class="p-6 flex flex-col flex-grow">
        <div class="text-sm text-ink-muted mb-2">15.01.2024</div>
...
<section class="bg-white px-6 py-24 md:py-32 xl:px-8">
    ...
    <figure class="mx-auto max-w-2xl">
        ...
        <blockquote class="text-xl italic tracking-tight text-ink md:text-2xl">
            <p>"Текст отзыва..."</p>
        </blockquote>
        <figcaption class="mt-10 flex items-center justify-center gap-x-6">
            <div class="text-sm">
                <div class="font-semibold text-ink">ИМЯ АВТОРА</div>
                <div class="mt-0.5 text-ink-soft">Дата</div>
            </div>
        </figcaption>
    </figure>
</section>
...
<section class="bg-secondary py-24 md:py-32">
    <div class="container xl:flex xl:items-center xl:justify-between">
        ...
        <div class="mt-10 flex flex-col md:flex-row items-center gap-4 md:gap-x-6 xl:mt-0 xl:shrink-0">
            ...
            <a href="#callback" class="inline-block px-6 py-2 bg-dark hover:bg-ah-900 text-white rounded uppercase transition-colors w-full md:w-auto text-center">
                Обратный звонок
            </a>
        </div>
    </div>
...
<footer class="bg-dark text-white">
    <div class="container">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 py-12">
            ...
            <div class="col-span-2 lg:col-span-1">
                ...
                <p class="text-sm text-white/70 leading-relaxed mb-5">Студия Muse — портреты на заказ и печать на холсте. <br>Работаем по всей России с 2015 года.</p>
                <div class="space-y-3 pt-3">
                    <div>
                        <p class="text-xs text-white/60 mb-1">Москва</p>
                    ...
                    <div>
                        <p class="text-xs text-white/60 mb-1">Санкт-Петербург</p>
            ...
            <div>
                ...
                <nav class="flex flex-col gap-3">
                    <a href="https://muse.ooo/portret-na-zakaz/" class="text-sm text-white/70 hover:text-white transition-colors">Портреты на заказ</a>
                    <a href="https://muse.ooo/portret-na-zakaz/portret-maslom/" class="text-sm text-white/70 hover:text-white transition-colors">Портрет маслом</a>
                    <a href="https://muse.ooo/pechat/" class="text-sm text-white/70 hover:text-white transition-colors">Печать на холсте</a>
                    <a href="https://muse.ooo/pechat/foto-na-kholste/" class="text-sm text-white/70 hover:text-white transition-colors">Фото на холсте</a>
                    <a href="https://muse.ooo/pechat/modulnye-kartiny/" class="text-sm text-white/70 hover:text-white transition-colors">Модульные картины</a>
                </nav>
            </div>
            <!-- Информация -->
            <div>
                ...
                <nav class="flex flex-col gap-3">
                    <a href="https://muse.ooo/info/oferta/" class="text-sm text-white/70 hover:text-white transition-colors">Публичная оферта</a>
                    <a href="https://muse.ooo/info/politika_konfidentsialnosti_sayta/" class="text-sm text-white/70 hover:text-white transition-colors">Политика конфиденциальности</a>
                    <a href="https://muse.ooo/info/guarantee/" class="text-sm text-white/70 hover:text-white transition-colors">Гарантия</a>
                    <a href="https://muse.ooo/karta-sayta/" class="text-sm text-white/70 hover:text-white transition-colors">Карта сайта</a>
                    <span class="text-sm text-white/60">ИНН 782575923262</span>
                    <span class="text-sm text-white/60">ОГРНИП 316784700066112</span>
                </nav>
            </div>
            <!-- Связь -->
            <div>
    ...
    <div>
        <div class="container py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="text-sm text-white/40">© 2015—2026 Muse</div>
        </div>
    </div>
</footer>
```
...
- [ ] Mobile-first: базовые стили = мобильные, расширяем через `sm:` → `md:` → `lg:` → `xl:`
- [ ] Page Navigator скрыт на мобильных (`max-width: 1023px`)
- [ ] Back to Top скрыт на мобильных (`hidden md:flex`)
- [ ] `max-*` диапазоны — только в CSS (`input.css`), не inline
- [ ] Dark mode (`dark:`) — не используется

### Доступность
- [ ] Icon-only кнопки: `aria-label` или `sr-only` текст
- [ ] Touch-target: интерактивные элементы ≥ 44×44 px
- [ ] SVG в кнопках: `aria-hidden="true"`
- [ ] `focus-visible:` вместо `focus:` на интерактивных элементах
- [ ] Контраст текста: ink-система (не `text-gray-*`)

### CSS-архитектура
- [ ] Новые повторяющиеся паттерны → `@utility` или `@layer components` (не копипаст inline)
