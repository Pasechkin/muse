---
status: "⚠️"
page: "Размер фотокартин и репродукций"
path: "src/html/blog/vybor-razmera-foto-i-reproduktsiy.html"
date: 2026-02-06
auditor: GitHub Copilot
---

# Аудит: Размер фотокартин и репродукций — src/html/blog/vybor-razmera-foto-i-reproduktsiy.html
