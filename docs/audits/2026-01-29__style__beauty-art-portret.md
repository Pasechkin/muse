...
- [x] Ссылки в тексте: без «кавычек» в тексте ссылки; стрелки используются по смыслу (`↑` внутри страницы, `↗` на другую страницу/внешний URL).
...
| ⚠️ | Нееинообразие оформления ссылок в тексте (кавычки/стрелки) | Секция «Как заказать» | Привести ссылки к одному формату: без кавычек; стрелки только по назначению | Закрепить правило в дизайн-системе и в чек-листе аудита |
