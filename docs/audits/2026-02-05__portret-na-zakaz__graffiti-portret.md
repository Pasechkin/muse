---
page: Портрет в стиле Граффити
path: src/html/portret-na-zakaz/style/graffiti-portret.html
date: 2026-02-05
auditor: GitHub Copilot
status: "✅"
---

# Аудит: Graffiti — src/html/portret-na-zakaz/style/graffiti-portret.html

Короткий вывод: структура и оптимизации в порядке; есть dev-meta и заглушки внешних виджетов.
...
- [x] decoding="async", loading="lazy" по умолчанию; LCP resource preloaded
- [x] Формат webp
- [x] SVG только inline
