---
status: "⚠️"
page: "7 преимуществ печати фото на холсте"
path: "src/html/blog/preimushchestva-pechati-foto-na-kholste.html"
date: 2026-02-06
auditor: GitHub Copilot
---

# Аудит: 7 преимуществ печати фото на холсте — src/html/blog/preimushchestva-pechati-foto-na-kholste.html
...
- [n/a] LCP ресурс: первый экран — текст/видео, правило LCP-изображения не применяется
- [x] Формат webp
- [x] SVG только inline
