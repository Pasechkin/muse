---
status: "⚠️"
page: "Что такое паспарту и как его правильно подобрать?"
path: "src/html/blog/paspartu.html"
date: 2026-02-06
auditor: GitHub Copilot
---

# Аудит: Что такое паспарту и как его правильно подобрать? — src/html/blog/paspartu.html
